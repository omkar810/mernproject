...
async function displayRazorpay() {
  ...
  const result = await axios.post("https://mernproject-fra4.onrender.com/payment/orders");
  ...
  const options = {
      ...
      handler: async function (response) {
          ...
          const result = await axios.post("https://mernproject-fra4.onrender.com/payment/success", data);
