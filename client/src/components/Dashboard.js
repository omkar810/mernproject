...
async function displayRazorpay() {
  ...
  const result = await axios.post("https://mernelearn.herokuapp.com/payment/orders");
  ...
  const options = {
      ...
      handler: async function (response) {
          ...
          const result = await axios.post("https://mernelearn.herokuapp.com/payment/success", data);
